...
<span style="color:blue;">정답:<br></span> 
</pre>

<span style="color:white;">정답: 3번</span>
<span style="color:white;">정답: </span>
-->
...
<span style="color:blue;">정답:<br>
fruit = '사과'<br>
count = 5<br>
price = 10000<br>
print(fruit, count, '개', price, '원')</span>
...
```python
# 코드를 완성하세요
print(f'{a}은 {b} 또는 {c} 를 갖는 자료형이다.')
```

실행 결과

```text
부울형은 True 또는 False 를 갖는 자료형이다.
```
...
b = True<br>
c = False<br>
print(f'{a}은 {b} 또는 {c} 를 갖는 자료형이다.')</span>
...
문제 2. 다음은 파이썬에서 연산자를 사용한 코드이다. 예상되는 결과를 고르시오. <span style="color:blue;">정답: 4번</span>
...
문제 1. 다음은 파이썬의 선택 제어문을 나타낸 코드이다. 올바르게 사용한 것을 고르시오. <span style="color:blue;">정답: 3번</span>
...
문제 2. 다음은 파이썬의 선택 제어문을 나타낸 코드이다. 잘못 사용한 것을 고르시오. <span style="color:blue;">정답: 1번</span>
