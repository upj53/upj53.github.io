...
b = True
c = False
print(f'{a}은 {b} 또는 {c} 를 갖는 자료형이다.')</pre>
...
문제 3. 다음 수식을 참고하여 키와 몸무게를 입력 받아 체질량 지수를 구하는 파이썬 코드를 완성하고, 아래 실행 결과와 같이 출력하세요.
